...
const Dropdown: React.FC<DropdownProps> = ({ day }) => {
    ...
    return (
        <div className="w-full flex justify-center">
            <div className="relative flex flex-col items-center w-[90%] lg:w-[50%] h-[300px] rounded-xl">
                ...
                {isOpen && (
                    <div className="bg-black absolute top-20 flex gap-5 flex-col items-start rounded-xl p-2 w-full">
